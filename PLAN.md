...
> - El módulo del agente para Agent Engine es **`agent/engine_app.py`** (no `root_agent.py`
>   como decía el diseño): envuelve el agente en un `AdkApp` con `GlobalGemini` y exige
